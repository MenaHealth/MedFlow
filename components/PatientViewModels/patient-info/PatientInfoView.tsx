...
const PatientInfoView: React.FC<{ isExpanded: boolean }> = ({ isExpanded }) => {
    ...
    const [patientData, setPatientData] = useState<Partial<PatientFormValues>>(defaultValues);
                    ...
                    <FormProvider {...form}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {isEditing
                                ...
                                : <ReadOnlyField fieldName="dob" fieldLabel="Date of Birth" value={expandedDetails.dob ? format(expandedDetails.dob, 'PPP') : expandedDetails.dob || 'N/A'}/>
                            }
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {isEditing
