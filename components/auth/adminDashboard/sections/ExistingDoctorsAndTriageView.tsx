...
export default function ExistingDoctorsAndTriageView() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            {/* Move status messages outside of ScrollArea and add more padding */}
