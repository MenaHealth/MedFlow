    ...
    function ForgotPasswordFormContent() {
        const { step, handleNextStep, form, submitting, handleResetPassword } = useForgotPasswordContext();
        ...
        return (
            <div className="w-full max-w-md space-y-4">
                ...
                {step === 4 && <ResetPasswordStep form={form} onSubmit={handleResetPassword} submitting={submitting} />}
            </div>
        );
    }
